...
## Historical correction recorded later

- this draft predates the 2026-05-07 updater-gap finding
- the published `RC19` line later proved insufficient as a baseline for the `RC19 -> RC20` launcher story because the installed RC19 MSI did not include `mfa-forge-launcher.exe`
- the canonical public `RC19 -> RC20` evidence was therefore corrected to a manual MSI upgrade path
