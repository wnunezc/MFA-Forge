...
- RC20 is the first installed line in this arc that actually ships `mfa-forge-launcher.exe`, but startup auto-update on GUI open was added later in the `RC21`/`RC22` line
