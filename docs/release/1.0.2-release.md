...
The `1.0.2` code and documentation can be merged before publication. Do not
create the public tag, GitHub Release, winget PR, or public release assets until
explicit publication approval is given. Until then, `1.0.1` remains the public
stable release and `1.0.2` remains the publishable hotfix candidate.
